...
RUN apt update && apt install -y vim wget curl net-tools dnsutils telnet traceroute gnupg2 postgresql-client redis-tools unzip apt-transport-https ca-certificates
